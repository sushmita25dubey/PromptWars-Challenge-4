...
export const LiveTranslation: React.FC = () => {
  ...
  const handleTranslate = async () => {
    ...
    try {
      ...
      const prompt = `Translate this text to ${languageMap[targetLang]}: "${sanitized}"`;
          ...
          <div className="flex items-center gap-3">
            <div className="flex-1 flex items-center gap-1.5 bg-slate-950 border border-slate-850 rounded-xl px-3 py-2 text-xs">
              ...
              <select
                ...
                className="bg-transparent border-none outline-none pr-1 focus:ring-0 text-slate-200 cursor-pointer font-semibold"
